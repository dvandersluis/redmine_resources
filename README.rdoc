...
== Requirements
* This plugin was developed for Redmine v0.8.
...
* The plugin makes use of a custom view hook called +view_issues_show_desc_bottom+. I have requested for this hook to be made official in Redmine, but until that happens, a patch is available to add it. The patch can be found in extra/issues_show_desc_bottom_hook.diff
